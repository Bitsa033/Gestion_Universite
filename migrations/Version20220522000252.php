 ...
 */
final class Version20220522000252 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE ue (id INT AUTO_INCREMENT NOT NULL, filiere_id INT DEFAULT NULL, niveau_id INT DEFAULT NULL, matiere_id INT DEFAULT NULL, user_id INT DEFAULT NULL, semestre_id INT DEFAULT NULL, created_at DATETIME NOT NULL, INDEX IDX_2E490A9B180AA129 (filiere_id), INDEX IDX_2E490A9BB3E9C81 (niveau_id), INDEX IDX_2E490A9BF46CD258 (matiere_id), INDEX IDX_2E490A9BA76ED395 (user_id), INDEX IDX_2E490A9B5577AFDB (semestre_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
