 ...
 */
final class Version20220118210923 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE etudiant (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, sexe VARCHAR(2) NOT NULL, created_at DATETIME NOT NULL, INDEX IDX_717E22E3A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE notes_etudiant (id INT AUTO_INCREMENT NOT NULL, inscription_id INT DEFAULT NULL, ue_id INT DEFAULT NULL, user_id INT DEFAULT NULL, created_at DATETIME NOT NULL, moyenne DOUBLE PRECISION NOT NULL, INDEX IDX_1D7861425DAC5993 (inscription_id), INDEX IDX_1D78614262E883B1 (ue_id), INDEX IDX_1D786142A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE ue (id INT AUTO_INCREMENT NOT NULL, filiere_id INT DEFAULT NULL, niveau_id INT DEFAULT NULL, matiere_id INT DEFAULT NULL, user_id INT DEFAULT NULL, created_at DATETIME NOT NULL, INDEX IDX_2E490A9B180AA129 (filiere_id), INDEX IDX_2E490A9BB3E9C81 (niveau_id), INDEX IDX_2E490A9BF46CD258 (matiere_id), INDEX IDX_2E490A9BA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
