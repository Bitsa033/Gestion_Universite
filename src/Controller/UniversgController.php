...
class UniversgController extends AbstractController
{
    ...
    /**
     * @Route("transfert_matiere/{id}", name="transfert_matiere")
     */
    public function transfert_matiere (Request $request, ManagerRegistry $end, Matiere $id)
    {
        ...
        foreach ($filieres as $f) {
            foreach ($niveaux as $n) {
                ...
                $manager->persist($ue);
                $manager->flush();
                return new Response('transfert effectué');
            }
        }
